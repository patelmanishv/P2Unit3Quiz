...
var recoveryData;
if (lbLocalStorage) {
recoveryData = lbLocalStorage.getItem("859e42171794b527588e7b42c0884bab23d23fd6_recovery_data");
}
...
if (lbLocalStorage) {
try {
lbLocalStorage.setItem("859e42171794b527588e7b42c0884bab23d23fd6_recovery_data", generate_suspend_data(true));
} catch (e) {
...
if (localStorage) localStorage.removeItem("859e42171794b527588e7b42c0884bab23d23fd6_recovery_data");
...
var seed = '859e42171794b527588e7b42c0884bab23d23fd6';
this.dummy = true;
...
if (localStorage) {
localStorage.removeItem("859e42171794b527588e7b42c0884bab23d23fd6_recovery_data");
}
});
